...
sudo.bat powershell.exe -file C:\Users\Public\removew10apps.ps1
sudo.bat C:\Users\Public\power.bat
sudo.bat C:\Users\Public\time.bat
sudo.bat C:\Users\Public\removeod.bat