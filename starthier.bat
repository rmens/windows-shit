...
curl -o C:\userpol.txt https://raw.githubusercontent.com/rmens/windows-shit/master/assets/userpol.txt 
...
START C:\Users\Public\LGPO.exe /r C:\userpol.txt /w C:\userpol.pol
START C:\Users\Public\LGPO.exe /un C:\userpol.pol
